...
Database.then(async (db) => {
    ...
    proffyValue = {
        ...
        bio: "Entusiasta das melhores tecnologias de química avançada.\n\n Apaixonado por explodir coisas em laboratório e por mudar a vida as pessoas através de experiências. Mais de 200.000 pessoas já passaram por uma das minhas explosões.",
    }
